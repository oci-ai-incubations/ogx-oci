...
| `pool_min` | `int` | No | 1 | Minimum number of connections in the Oracle pool |
| `pool_max` | `int` | No | 10 | Maximum number of connections in the Oracle pool |
| `pool_ping_interval` | `int` | No | 60 | Seconds between connection health checks (oracledb pool ping_interval) |
