...
| Metric | Value |
|--------|-------|
| **Overall Conformance Score** | 93.9% |
| **Endpoints Implemented** | 29/146 |
| **Total Properties Checked** | 3432 |
| **Schema/Type Issues** | 145 |
| **Missing Properties** | 66 |
| **Total Issues to Fix** | 211 |
...
**Score:** 84.5% · **Issues:** 36 · **Missing:** 12
